 ...
 *
 * Copyright (C) 2016 - 2022 Austin "fazuedevelopment" Shapiro
 *
...
package github.fazuedevelopment.cosdiscord;
...
import github.fazuedevelopment.cosdiscord.configuralize.DynamicConfig;
import github.fazuedevelopment.configuralize.Language;
import github.fazuedevelopment.configuralize.ParseException;
import github.fazuedevelopment.cosdiscord.api.ApiManager;
import github.fazuedevelopment.cosdiscord.api.events.*;
import github.fazuedevelopment.cosdiscord.hooks.PluginHook;
import github.fazuedevelopment.cosdiscord.hooks.VaultHook;
import github.fazuedevelopment.cosdiscord.hooks.chat.ChatHook;
import github.fazuedevelopment.cosdiscord.hooks.vanish.VanishHook;
import github.fazuedevelopment.cosdiscord.hooks.world.MultiverseCoreHook;
import github.fazuedevelopment.cosdiscord.listeners.*;
import github.fazuedevelopment.cosdiscord.modules.alerts.AlertListener;
import github.fazuedevelopment.cosdiscord.modules.requirelink.RequireLinkModule;
import github.fazuedevelopment.cosdiscord.modules.voice.VoiceModule;
import github.fazuedevelopment.cosdiscord.objects.CancellationDetector;
import github.fazuedevelopment.cosdiscord.objects.Lag;
import github.fazuedevelopment.cosdiscord.objects.MessageFormat;
import github.fazuedevelopment.cosdiscord.objects.log4j.JdaFilter;
import github.fazuedevelopment.cosdiscord.objects.managers.AccountLinkManager;
import github.fazuedevelopment.cosdiscord.objects.managers.CommandManager;
import github.fazuedevelopment.cosdiscord.objects.managers.GroupSynchronizationManager;
import github.fazuedevelopment.cosdiscord.objects.managers.IncompatibleClientManager;
import github.fazuedevelopment.cosdiscord.objects.managers.link.FileAccountLinkManager;
import github.fazuedevelopment.cosdiscord.objects.managers.link.JdbcAccountLinkManager;
import github.fazuedevelopment.cosdiscord.objects.proxy.AlwaysEnabledPluginDynamicProxy;
import github.fazuedevelopment.cosdiscord.objects.threads.*;
import github.fazuedevelopment.cosdiscord.util.*;
import lombok.Getter;
import me.fazuedevelopment.jdaappender.ChannelLoggingHandler;
import me.fazuedevelopment.jdaappender.LogItem;
import me.fazuedevelopment.jdaappender.LogLevel;
...
public class DiscordSRV extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        initThread.setUncaughtExceptionHandler((t, e) -> {
            ...
            disablePlugin();
            error(e);
            getLogger().severe("DiscordSRV failed to load properly: " + e.getMessage() + ". See " + github.fazuedevelopment.cosdiscord.util.DebugUtil.run("DiscordSRV") + " for more information. Can't figure it out? Go to https://discordsrv.com/discord for help");
        });
        initThread.start();
    ...
    public void init() {
        ...
        if (serverIsLog4j21Capable && jdaFilter == null) {
            try {
                Class<?> jdaFilterClass = Class.forName("github.fazuedevelopment.cosdiscord.objects.log4j.JdaFilter");
        ...
        if (serverIsLog4jCapable) {
            ...
            if (consoleChannel != null) {
                ...
                consoleAppender = new ChannelLoggingHandler(() -> {
                    ...
                    config.mapLoggerName("github.fazuedevelopment.cosdiscord.dependencies.jda", s -> "DiscordSRV/JDA/" + s);
...
//        Bukkit.getMessenger().registerIncomingPluginChannel(this, "lunarclient:pm", incompatibleClientManager);
        ...
        for (String hookClassName : new String[]{
                // chat plugins
                "github.fazuedevelopment.cosdiscord.hooks.chat.ChattyChatHook",
                "github.fazuedevelopment.cosdiscord.hooks.chat.FancyChatHook",
                "github.fazuedevelopment.cosdiscord.hooks.chat.HerochatHook",
                "github.fazuedevelopment.cosdiscord.hooks.chat.LegendChatHook",
                "github.fazuedevelopment.cosdiscord.hooks.chat.LunaChatHook",
                "github.fazuedevelopment.cosdiscord.hooks.chat.TownyChatHook",
                "github.fazuedevelopment.cosdiscord.hooks.chat.VentureChatHook",
                // vanish plugins
                "github.fazuedevelopment.cosdiscord.hooks.vanish.EssentialsHook",
                "github.fazuedevelopment.cosdiscord.hooks.vanish.PhantomAdminHook",
                "github.fazuedevelopment.cosdiscord.hooks.vanish.SuperVanishHook",
                "github.fazuedevelopment.cosdiscord.hooks.vanish.VanishNoPacketHook",
                // dynmap
                "github.fazuedevelopment.cosdiscord.hooks.DynmapHook",
                // luckperms
                "github.fazuedevelopment.cosdiscord.hooks.permissions.LuckPermsHook"
        }) {
            try {
            ...
            try {
                ...
                Bukkit.getScheduler().runTask(this, () -> {
                    try {
                        ...
                        new github.fazuedevelopment.cosdiscord.hooks.PlaceholderAPIExpansion().register();
                    } catch (Throwable ignored) {
        ...
        if (command.equals(""))
            return new ArrayList<String>() {{
                for (Map.Entry<String, Method> command : getCommandManager().getCommands().entrySet())
                    if (GamePermissionUtil.hasPermission(sender, command.getValue().getAnnotation(github.fazuedevelopment.cosdiscord.commands.Command.class).permission()))
                        add(command.getKey());
            }};
            ...
            return new ArrayList<String>() {{
                for (Map.Entry<String, Method> commandPair : getCommandManager().getCommands().entrySet())
                    if (commandPair.getKey().toLowerCase().startsWith(command.toLowerCase()))
                        if (GamePermissionUtil.hasPermission(sender, commandPair.getValue().getAnnotation(github.fazuedevelopment.cosdiscord.commands.Command.class).permission()))
