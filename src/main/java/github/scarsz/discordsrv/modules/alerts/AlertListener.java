...
package github.fazuedevelopment.cosdiscord.modules.alerts;
...
import github.fazuedevelopment.cosdiscord.api.Subscribe;
import github.fazuedevelopment.cosdiscord.objects.ExpiringDualHashBidiMap;
...
public class AlertListener implements Listener, EventListener {
    ...
    @Subscribe
    public void onDSRVEvent(github.fazuedevelopment.cosdiscord.api.events.Event event) {
        runAlertsForEvent(event);
    }
