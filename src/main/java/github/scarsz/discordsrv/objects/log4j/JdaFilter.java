...
package github.fazuedevelopment.cosdiscord.objects.log4j;
...
public class JdaFilter implements Filter {
    ...
    public Result check(String loggerName, Level level, String message, Throwable throwable) {
        ...
        if (!loggerName.startsWith("github.fazuedevelopment.cosdiscord.dependencies.jda")) return Result.NEUTRAL;
