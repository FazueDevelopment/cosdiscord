...
package github.fazuedevelopment.cosdiscord.objects.managers.link;

import github.fazuedevelopment.cosdiscord.Debug;
import github.fazuedevelopment.cosdiscord.DiscordSRV;
import github.fazuedevelopment.cosdiscord.api.events.AccountLinkedEvent;
import github.fazuedevelopment.cosdiscord.api.events.AccountUnlinkedEvent;
...
import github.fazuedevelopment.cosdiscord.util.DiscordUtil;
import github.fazuedevelopment.cosdiscord.util.PluginUtil;
import github.fazuedevelopment.cosdiscord.util.PrettyUtil;
...
public abstract class AbstractAccountLinkManager extends AccountLinkManager {
    ...
    protected void ensureOffThread(boolean single) {
        ...
        if (apiUser.startsWith("github.fazuedevelopment.cosdiscord")) {
