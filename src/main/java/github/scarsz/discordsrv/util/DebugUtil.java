...
package github.fazuedevelopment.cosdiscord.util;

import alexh.weak.Dynamic;
import com.github.kevinsawicki.http.HttpRequest;
import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.google.gson.Gson;
import fazuedevelopment.configuralize.Language;
import github.fazuedevelopment.cosdiscord.Debug;
import github.fazuedevelopment.cosdiscord.DiscordSRV;
import github.fazuedevelopment.cosdiscord.api.events.DebugReportedEvent;
import github.fazuedevelopment.cosdiscord.hooks.PluginHook;
import github.fazuedevelopment.cosdiscord.hooks.SkriptHook;
...
import github.fazuedevelopment.cosdiscord.listeners.DiscordDisconnectListener;
    ...
    private static String getThreads() {
        ...
        for (Map.Entry<Thread, StackTraceElement[]> entry : stackTraces.entrySet()) {
            ...
            if ((threadName.contains("DiscordSRV") || Arrays.stream(traceElements)
                    .anyMatch(trace -> trace.getClassName().startsWith("github.fazuedevelopment.cosdiscord"))
    ...
    private static String uploadReport(List<Map<String, String>> files, int aesBits, String requester) {
        ...
        try {
            return executor.invokeAny(Collections.singletonList(() -> {
                try {
                    String url = uploadToBin("https://bin.cosdiscord.me", aesBits, files, "Requested by " + requester);
            ...
            return "GENERATED TO FILE/Failed to upload to bin.cosdiscord.me, placed into plugins/DiscordSRV/debug/" + debugName
