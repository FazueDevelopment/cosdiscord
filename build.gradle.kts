...
publishing {
    repositories {
        maven {
            val repository = "https://github.com/FazueDevelopment/cosdiscord"
...
tasks {
    ...
    register("commitVersion") {
        doLast {
            ...
            git.commit()
                .setAuthor("github.fazuedevelopment.cosdiscord", "")
                .setMessage(v).call()
        }
    }
    ...
    shadowJar {
        ...
        mustRunAfter("build")
        minimize {
            exclude(dependency("fazuedevelopment:configuralize:.*"))
            exclude(dependency("me.cosdiscord:jdaappender:.*"))
            exclude(dependency("com.fasterxml.jackson.core:jackson-databind:.*"))
        }

        relocate("net.dv8tion.jda", "github.fazuedevelopment.cosdiscord.dependencies.jda")
        relocate("com.iwebpp.crypto", "github.fazuedevelopment.cosdiscord.dependencies.iwebpp.crypto")
        relocate("com.vdurmont.emoji", "github.fazuedevelopment.cosdiscord.dependencies.emoji")
        relocate("com.neovisionaries.ws", "github.fazuedevelopment.cosdiscord.dependencies.ws")
        relocate("net.kyori", "github.fazuedevelopment.cosdiscord.dependencies.kyori")
        relocate("dev.vankka.mcdiscordreserializer", "github.fazuedevelopment.cosdiscord.dependencies.mcdiscordreserializer")
        relocate("dev.vankka.simpleast", "github.fazuedevelopment.cosdiscord.dependencies.simpleast")
        relocate("org.bstats", "github.fazuedevelopment.cosdiscord.dependencies.bstats")
        relocate("org.apache.commons", "github.fazuedevelopment.cosdiscord.dependencies.commons")
        relocate("org.json.simple", "github.fazuedevelopment.cosdiscord.dependencies.json.simple")
        relocate("org.json", "github.fazuedevelopment.cosdiscord.dependencies.json")
        relocate("org.minidns", "github.fazuedevelopment.cosdiscord.dependencies.minidns")
        relocate("okhttp3", "github.fazuedevelopment.cosdiscord.dependencies.okhttp3")
        relocate("okio", "github.fazuedevelopment.cosdiscord.dependencies.okio")
        relocate("gnu.trove", "github.fazuedevelopment.cosdiscord.dependencies.trove")
        relocate("com.fasterxml.jackson", "github.fazuedevelopment.cosdiscord.dependencies.jackson")
        relocate("com.google.common", "github.fazuedevelopment.cosdiscord.dependencies.google.common")
        relocate("com.google.errorprone", "github.fazuedevelopment.cosdiscord.dependencies.google.errorprone")
        relocate("com.google.gson", "github.fazuedevelopment.cosdiscord.dependencies.google.gson")
        relocate("com.google.j2objc", "github.fazuedevelopment.cosdiscord.dependencies.google.j2objc")
        relocate("com.github.kevinsawicki", "github.fazuedevelopment.cosdiscord.dependencies.kevinsawicki")
        relocate("com.github.zafarkhaja", "github.fazuedevelopment.cosdiscord.dependencies.zafarkhaja")
        relocate("alexh", "github.fazuedevelopment.cosdiscord.dependencies.alexh")
...
repositories {
    ...
    maven("https://nexus.cosdiscord.me/content/groups/public/")
}
...
dependencies {
    ...
    // Config
    api("fazuedevelopment:configuralize:1.3.2") {
    ...
    // Logging
    implementation("me.cosdiscord:jdaappender:1.0.3")
